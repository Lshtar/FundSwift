...
fileprivate let DefaultTitleSize:CGFloat = 18
...
class CustomNavigationBar: UIView {
    ...
    */
    ...
    fileprivate lazy var titleLabel:UILabel = {
        ...
        label.font = UIFont.systemFont(ofSize: DefaultTitleSize)
    ...
    // init
    class func CustomNavBar() -> CustomNavigationBar {
    ...
    func updateFrame()
    {
        //let top:CGFloat = CustomNavigationBar.isIphoneX ? 44 : 20
        ...
        leftButton.frame = CGRect(x: margin, y: StatusBar_Height, width: buttonWidth, height: buttonHeight)
        rightButton.frame = CGRect(x: Screen_Width-buttonWidth-margin, y: StatusBar_Height, width: buttonWidth, height: buttonHeight)
        titleLabel.frame = CGRect(x: (Screen_Width-titleLabelWidth)/2.0, y: StatusBar_Height, width: titleLabelWidth, height: titleLabelHeight)
